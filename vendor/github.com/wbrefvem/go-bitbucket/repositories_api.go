...
@return Commitstatus*/
func (a *RepositoriesApiService) RepositoriesUsernameRepoSlugCommitNodeStatusesBuildKeyGet(ctx context.Context, username string, node string, key string, repoSlug string) (Commitstatus, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return Commitstatus*/
func (a *RepositoriesApiService) RepositoriesUsernameRepoSlugCommitNodeStatusesBuildKeyPut(ctx context.Context, username string, node string, key string, repoSlug string, localVarOptionals map[string]interface{}) (Commitstatus, *http.Response, error) {
	var (
...
@return Commitstatus*/
func (a *RepositoriesApiService) RepositoriesUsernameRepoSlugCommitNodeStatusesBuildPost(ctx context.Context, username string, node string, repoSlug string, localVarOptionals map[string]interface{}) (Commitstatus, *http.Response, error) {
	var (
...
func (a *RepositoriesApiService) RepositoriesUsernameRepoSlugCommitNodeStatusesGet(ctx context.Context, username string, node string, repoSlug string) (PaginatedCommitstatuses, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@param repoSlug This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: &#x60;{repository UUID}&#x60;.
@return PaginatedCommitstatuses*/
func (a *RepositoriesApiService) RepositoriesUsernameRepoSlugPullrequestsPullRequestIdStatusesGet(ctx context.Context, username string, pullRequestId int32, repoSlug string) (PaginatedCommitstatuses, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@param repoSlug This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: &#x60;{repository UUID}&#x60;.
@return */
func (a *RepositoriesApiService) RepositoriesUsernameRepoSlugWatchersGet(ctx context.Context, username string, repoSlug string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
